/*
    $Id: parsefnacloc.cpp,v 1.1 2002/06/06 17:21:52 thementat Exp $
...
int IcqProtocol::parseFnacLoc(const FSPacket &fs)
{
  debug() << "> LOC ";
  switch (fs.subtype())
    {
    ...
    default:
      debug() << "> Error" << endl;
      packetError(&fs, "Unknown LOC subtype %d\n", fs.subtype());
      return -1;
      break;
    }
  return 0;
